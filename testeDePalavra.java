class TesteDePalavra
{
    public static void main (String[] args)
    {
        ...
        System.out.println ("\"PARALELEPIPEDO\" tem "+
                            p3.getQuantidadeDaLetra('W') +
                            " letras iguais a 'W'");
                            
        // teste 7 --> CERTO
        System.out.println ("TESTE 7");
        System.out.println ("\"PARALELEPIPEDO\" tem "+
                            p3.getQuantidadeDaLetra('E') +
                            " letras iguais a 'E'");
        ...
        try
        {
            ...
            p3.getPosicaoDeOcorrenciaDaLetra(-1,'E'));
        ...
        try
        {
            ...
            System.out.println ("A 1a letra 'E' de \"PARALELEPIPEDO\" fica na posicao " +
            p3.getPosicaoDeOcorrenciaDaLetra(0,'E'));
            System.out.println ("Achamos a 1a aparicao da letra 'E' em \"PARALELEPIPEDO\"");
        }
        catch (Exception erro)
        {
        ...
        try
        {
            ...
            p3.getPosicaoDeOcorrenciaDaLetra(2,'E'));
        ...
        try
        {
            ...
            p3.getPosicaoDeOcorrenciaDaLetra(3,'E'));
        ...
        // teste 18 --> ERRO! equals dando falso! 
        ...
        // teste 21 --> ERRO(?) acho q arrumamos, n lembro ;) 
